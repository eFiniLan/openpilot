...
class Car:
  ...
  def controls_update(self, CS: car.CarState, CC: car.CarControl):
    ...
    if self.sm.all_alive(['carControl']):
      ...
      if self.sm.updated['sendcanExt']:
        can_send_exts = self.sm['sendcanExt']
        for can_send_ext in can_send_exts:
          can_sends.append([can_send_ext.address, can_send_ext.dat, can_send_ext.src])
